...
function Login() {
  ...
  return (
    <div className="bg-[#151515] h-screen w-full flex items-center justify-center min-h-[700px]">
      <div className="bg-gray-900 h-[600px] w-[500px] flex flex-col items-center justify-center rounded-2xl  ">
        <form onSubmit={handleSubmit(handleLogin)}>
          <div className="relative flex w-96 flex-col rounded-xl bg-gray-800 bg-clip-border text-gray-700 shadow-md">
            ...
            <div className="flex flex-col gap-4 p-6">
              <div className="relative h-11 w-full min-w-[200px]">
                <input
                  placeholder=""
                  className="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-white outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-cyan-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                  {...register("email", {
                    required: true,
                    validate: {
                      matchPattern: (value) =>
            ...
            <div className="p-6 pt-0">
              ...
              <div className="mt-6 flex justify-center font-sans text-sm font-light leading-normal text-white antialiased">
                Don't have an account?
                <p className="ml-1 font-sans text-sm font-bold leading-normal text-cyan-500 antialiased inline-block hover:underline">
